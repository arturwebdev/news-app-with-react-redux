    ...
    <div className="top">
      ...
      <section id="content-wrap" className="site-page">
        <div className="content-media">
          <img src={require("../../images/about-us.jpg")} alt="" />
        </div>
        ...
        <div className="primary-content">
          ...
          <p>
            Lorem ipsum Cillum sit sunt dolore non aute enim pariatur deserunt
            magna reprehenderit veniam officia ullamco eiusmod laborum commodo
            veniam elit proident enim sit cillum ex aliquip dolore labore sint
            ut deserunt officia veniam consectetur in in quis eu consectetur non
            sint Duis mollit Ut magna irure.
          </p>
          ...
          <div className="row block-1-2 block-tab-full">
            <div className="bgrid">
              <h3>Who.</h3>
              <p>
                Lorem ipsum Nisi amet fugiat eiusmod et aliqua ad qui ut nisi Ut
                aute anim mollit fugiat qui sit ex occaecat et eu mollit nisi
                pariatur fugiat deserunt dolor veniam reprehenderit aliquip
                magna nisi consequat aliqua veniam in aute ullamco Duis laborum
                ad non pariatur sit.
              </p>
            </div>
